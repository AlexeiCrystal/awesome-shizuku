...
* [RootlessJamesDSP](https://play.google.com/store/apps/details?id=me.timschneeberger.rootlessjamesdsp) - Реализация общесистемного движка обработки звука JamesDSP для устройств Android без root `GPL-3.0` [(Source code)](https://github.com/timschneeb/RootlessJamesDSP)
