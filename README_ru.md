...
### Языки
[English](/README.md) | Русский | [简体中文](/README_cn.md)

[![Awesome](https://cdn.jsdelivr.net/gh/sindresorhus/awesome@d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome)

Shizuku позволяет обычным приложениям использовать системные API напрямую с помощью ADB на устройствах без root. В этом списке собраны некоторые приложения, которые, используют возможности Shizuku.

Подробнее: https://shizuku.rikka.app/

Пулл реквесты приветствуются. Посмотрите [Contributing](CONTRIBUTING.md) для помощи.
...
- [Приложения](#приложения)
  ...
  - [Инструменты для разработки](#development-utilities)
  - [Device Owner (DPM)](#device-owner-dpm)
  - [Display management](#display-management)
  - [Entertainment](#entertainment)
  - [Управление файлами](#file-management)
  - [Игры](#games)
  - [Способы ввода](#input-methods)
  - [Установщики и магазины приложений](#installer--app-stores)
...
* [RootlessJamesDSP](https://play.google.com/store/apps/details?id=me.timschneeberger.rootlessjamesdsp) - Реализация общесистемного движка обработки звука JamesDSP для устройств Android без root `GPL-3.0` [(Исходный код)](https://github.com/timschneeb/RootlessJamesDSP)
* [VolumeManager](https://github.com/yume-chan/VolumeManager) - Регулировка громкости каждого приложения независимо друг от друга `GPL-2.0`

### Автоматизация

* [AutoJs6](https://github.com/SuperMonster003/AutoJs6) - Инструмент для автоматизации основанный на JavaScript `MPL-2.0`
* [PhoneProfilesPlus](https://github.com/henrichg/PhoneProfilesPlus) - Позволяет создавать автоматизации и конфигурации для различных жизненных  ситуаций `Apache-2.0`
* [MacroDroid](https://play.google.com/store/apps/details?id=com.arlosoft.macrodroid) `Ads` `IAP` 💰 - Приложения для автоматизации на устройствах Android. Версия 5.46 и новее поддерживает Shizuku `Proprietary`
...
* [Bunny-Manager](https://github.com/bunny-mod/BunnyManager) - Менеджер патчей для модификации Discord Bunny `OSL-3.0`
* [CatShare](https://f-droid.org/packages/moe.reimu.catshare/) - Отправка и получение файлов по Bluetooth `MIT` [(Source code)](https://github.com/kmod-midori/CatShare)
...
* [TxtNet-Browser](https://github.com/lukeaschenbrenner/TxtNet-Browser) - Приложение, позволяющее просматривать веб-страницы через SMS. `GPL-3.0`
...
* [AmbientMusicMod](https://github.com/KieronQuinn/AmbientMusicMod) - Порт функции "Сейчас играет" из Google Pixel на другие устройства `GPL-3.0`
...
* [AutoRotate](https://github.com/eiyooooo/AutoRotate) - Управление автоматическим поворотом экрана в различных приложениях в Android `GPL-3.0`
...
* [ColorBlendr](https://github.com/Mahmud0808/ColorBlendr) - Приложение для модификации цветовой палитры Mater You вашего устройства `GPL-3.0`
...
* [Language-Selector](https://github.com/VegaBobo/Language-Selector) - Позволяет настраивать языки индивидуально для разных приложений (Android 13+) `Apache-2.0`
...
Этот список лицензирован [Creative Commons Attribution-ShareAlike 3.0 Unported](https://creativecommons.org/licenses/by-sa/3.0/deed.en) Лицензией
